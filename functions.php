...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('custom-size', 700, 200, true); // Custom Thumbnail Size call using the_post_thumbnail('slide-bg');
    add_image_size('slide-bg', 786, 400, true);
    add_image_size('hpthumb', 300, 169, true);
...
function html5blank_header_scripts()
{
    if (!is_admin()) {
        ...
        wp_register_script('sliderscript', get_template_directory_uri() . '/js/jquery.carouFredSel-6.2.1-packed.js', array(), '1.0.0'); // Custom scripts
        wp_enqueue_script('sliderscript'); // Enqueue it!
        
        wp_register_script('swipetouch', get_template_directory_uri() . '/js/jquery.touchSwipe.min.js', array(), '1.0.0'); // Custom scripts
        wp_enqueue_script('swipetouch'); // Enqueue it!
    }
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Homepage Widget Area', 'html5blank'),
        'description' => __('Homepage Widget area block', 'html5blank'),
        'id' => 'home-area-1',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
...
function html5wp_slider($length) // Create 20 Word Callback for Index page Excerpts, call using html5wp_excerpt('html5wp_index');
{
    return 20;
}
...
function create_post_type_html5()
{
    ...
    register_post_type('slides', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Slides', 'html5blank'), // Rename these to suit
